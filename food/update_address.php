...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" class="box" placeholder="Region" required maxlength="50" name="town">
      <input type="text" class="box" placeholder="Vile" required maxlength="50" name="city">
      <input type="text" class="box" placeholder="Etat" required maxlength="50" name="state">
      <input type="text" class="box" placeholder="Pays" required maxlength="50" name="country">
